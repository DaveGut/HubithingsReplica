/*	HubiThings Replica Refrigerator icemaker Driver
...
def appliance() { return "ReplicaSamsungRefrigeratorIcemaker" }
...
String helpLogo() {
	return """<a href="https://github.com/DaveGut/HubitatActive/blob/master/HubiThingsReplica/Docs/SamsungRefrigeratorReadme.md">""" +
...
def setOnOff(onOff) {
	sendCommandToParent("switch", onOff, [])
	logInfo("setOnOff: ${onOff}")
}
